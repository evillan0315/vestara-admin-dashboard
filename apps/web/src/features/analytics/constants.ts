...
export const ACTION_LABELS: Record<AuditAction, string> = {
  ...
  [AuditAction.PROFILE_UPDATE]: 'Profile Update',
  [AuditAction.KYC_SUBMIT]: 'KYC Submit',
  [AuditAction.KYC_DOCUMENT_UPLOAD]: 'KYC Document Upload',
  [AuditAction.KYC_DOCUMENT_DELETE]: 'KYC Document Delete',
